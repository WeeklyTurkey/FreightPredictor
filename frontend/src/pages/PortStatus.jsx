...
export default function PortStatus() {
 ...
 disabled={checking}
 className="bg-teal-600 hover:bg-teal-700 text-white px-5 py-2 font-semibold text-sm shadow-sm transition-all flex items-center gap-2"
 >
 {checking ? (
 <>
 ...
 {feasibilityResult ? (
 <div className="lg:col-span-2 bg-white p-4 border border-slate-200 shadow-sm space-y-3">
 ...
 <div className="grid grid-cols-3 gap-2 text-xs bg-slate-50 p-2.5 border border-slate-100">
 <div>
 ...
 <div className="lg:col-span-2 bg-white/70 p-6 border border-dashed border-slate-300 text-center text-slate-400 text-sm">
 ...
 {portStatus.map((port) => (
 <div key={port.port} className="bg-slate-50 p-5 border border-slate-100 hover:border-slate-200 transition-all">
 ...
 <div className="h-2 bg-slate-200 -full overflow-hidden">
 <div
