...
export default function FleetReadiness() {
 ...
 <div className="flex flex-col justify-center bg-slate-50 p-6 border border-slate-100">
 ...
 <div className="flex flex-col justify-center bg-teal-50/50 p-6 border border-teal-100">
 ...
 <div className="flex flex-col justify-center bg-amber-50/50 p-6 border border-amber-100">
