...
export default function ScenarioSimulator() {
 ...
 className={`flex-1 py-3 px-4 text-sm font-medium transition-all shadow-sm ${
 simCharterType === 'spot' 
 ...
 <div className="grid grid-cols-2 gap-2 text-sm text-slate-500 bg-slate-50 p-3 ">
 ...
 <div className="flex items-center justify-between p-4 bg-teal-50 border border-teal-200">
 ...
 <div className="p-1.5 bg-slate-100 shrink-0">
