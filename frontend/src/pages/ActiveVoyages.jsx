...
export default function ActiveVoyages() {
 ...
 {voyages.map((voyage) => (
 <div key={voyage.id} className="bg-slate-50 p-4 border border-slate-100 hover:border-slate-200 transition-colors">
 ...
 <div className="flex-1 h-2 bg-slate-200 -full overflow-hidden">
 <div
 className="h-full bg-teal-500 -full transition-all duration-500"
