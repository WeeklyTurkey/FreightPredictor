...
export default function RecommendationCard({ recommendation, compact = false }) {
 ...
 <div className={`p-2.5 ${config.iconBg}`}>
 ...
 <div className="w-24 h-1.5 bg-slate-100 -full overflow-hidden">
 <div
 className={`h-full -full ${config.iconBg} transition-all duration-500`}
 ...
 className="flex items-center justify-center gap-2 w-full py-2 text-sm font-medium text-teal-600 hover:text-teal-700 border border-teal-200 hover:bg-teal-50 transition-all"
 >
 View Full Analysis
