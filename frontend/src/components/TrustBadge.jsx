export default function TrustBadge({ score, size = 'md' }) {
 ...
 return (
 <span className={`inline-flex items-center gap-1.5 ${sizeClasses} ${colors.bg} ${colors.text} border ${colors.border} -full font-medium`}>
 <span className={`w-1.5 h-1.5 -full ${colors.dot}`} />
