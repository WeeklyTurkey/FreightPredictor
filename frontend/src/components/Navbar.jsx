...
function NavDropdown({ section, isActive }) {
 ...
 <div className="bg-white border border-slate-200 shadow-lg shadow-slate-200/50 py-2">
 ...
 className="w-full flex items-start gap-3 px-4 py-3 group hover:text-teal-600 transition-colors text-left"
 >
 <div className="p-1.5 bg-slate-100 mt-0.5 transition-colors">
 <item.icon className="w-4 h-4 text-slate-500 group-hover:text-teal-600 transition-colors" />
 </div>
 <div>
 <p className="text-sm font-medium text-slate-800 group-hover:text-teal-600 transition-colors">{item.label}</p>
...
export default function Navbar() {
 ...
 <div className="p-1.5 bg-teal-600">
 ...
 <button className="p-2 text-slate-400 hover:text-slate-600 transition-colors hidden md:flex">
 <Search className="w-4.5 h-4.5" />
 </button>
 <button className="p-2 text-slate-400 hover:text-slate-600 transition-colors relative hidden md:flex">
 <Bell className="w-4.5 h-4.5" />
 <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-teal-500 -full" />
 </button>
 <div className="hidden md:block w-px h-6 bg-slate-200 mx-1" />
 <div className="hidden md:flex items-center gap-2 pl-1">
 <div className="w-8 h-8 -full bg-gradient-to-br from-teal-500 to-emerald-600 flex items-center justify-center text-white text-xs font-bold">
 FC
 </div>
 </div>
